...
co = co.withColumn('date', lit('2018-01-01'))
...
co_two_yr.write.format("delta").saveAsTable(".ccu049_nocovidh_death")
...
co_apc_two_yr.write.format("delta").saveAsTable(".ccu049_nocovidh_hosp")
