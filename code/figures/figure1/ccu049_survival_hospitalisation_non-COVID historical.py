...
co_two_yr.write.format("delta").saveAsTable("dsa_391419_j3w9t_collab.ccu049_nocovidh_death")
...
co_apc_two_yr.write.format("delta").saveAsTable("dsa_391419_j3w9t_collab.ccu049_nocovidh_hosp")
