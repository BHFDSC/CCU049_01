...
save_checkpoint(df_in=co_yr, database="", temp_df="ccu049_onlycovid_death", global_view_name="ccu049")
...
co_apc_two_yr.write.format("delta").saveAsTable(".ccu049_onlycovid_hosp")
