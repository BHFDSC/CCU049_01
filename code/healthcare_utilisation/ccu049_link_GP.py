...
gdppr_archive = spark.sql(f'select * from .gdppr__archive')
...
# MAGIC %sql
# MAGIC DROP TABLE .ccu049_onlycovid_gp_v2

# COMMAND ----------

#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_longc_gp_v2", global_view_name="ccu049")
#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_longcoh_gp_v2", global_view_name="ccu049")
#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_nocovidc_gp_v2", global_view_name="ccu049")
#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_nocovidh_gp_v2", global_view_name="ccu049")
save_checkpoint(df_in=co_final, database="", temp_df="ccu049_onlycovid_gp_v2", global_view_name="ccu049")
