...
hes_op_archive = spark.sql(f'select * from .hes_op_all_years_archive')
...
# MAGIC %sql
# MAGIC DROP TABLE .ccu049_longc_op_v2

# COMMAND ----------

#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_longc_op_v2", global_view_name="ccu049")
#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_longcoh_op_v2", global_view_name="ccu049")
save_checkpoint(df_in=co_final, database="", temp_df="ccu049_nocovidc_op_v2", global_view_name="ccu049")
#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_nocovidh_op_v2", global_view_name="ccu049")
#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_onlycovid_op_v2", global_view_name="ccu049")
