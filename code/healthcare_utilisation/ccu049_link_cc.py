...
#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_longc_cc_v2", global_view_name="ccu049")
#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_longcoh_cc_v2", global_view_name="ccu049")
save_checkpoint(df_in=co_final, database="", temp_df="ccu049_nocovidc_cc_v2", global_view_name="ccu049")
#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_nocovidh_cc_v2", global_view_name="ccu049")
#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_onlycovid_cc_v2", global_view_name="ccu049")
