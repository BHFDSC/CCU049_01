...
# MAGIC %sql
# MAGIC DROP TABLE .ccu049_longc_apc_v2

# COMMAND ----------

#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_longc_apc_v2", global_view_name="ccu049")
#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_longcoh_apc_v2", global_view_name="ccu049")
save_checkpoint(df_in=co_final, database="", temp_df="ccu049_nocovidc_apc_v2", global_view_name="ccu049")
#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_nocovidh_apc_v2", global_view_name="ccu049")
#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_onlycovid_apc_v2", global_view_name="ccu049")
