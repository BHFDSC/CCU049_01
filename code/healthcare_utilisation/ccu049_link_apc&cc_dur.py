...
#cohort = ".ccu049_cohortc"
#start_date = "2020-01-29"
#end_date = "2022-03-31"

# 4. Pre-pandemic non-COVID (historical)
#cohort = ".ccu049_cohorth"
#start_date = "2018-01-01"
#end_date = "2019-12-31"
...
# MAGIC %sql
# MAGIC DROP TABLE .ccu049_onlycovid_dur_v2

# COMMAND ----------

#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_longc_dur_v2", global_view_name="ccu049")
#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_longcoh_dur_v2", global_view_name="ccu049")
#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_nocovidc_dur_v2", global_view_name="ccu049")
#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_nocovidh_dur_v2", global_view_name="ccu049")
save_checkpoint(df_in=co_final, database="", temp_df="ccu049_onlycovid_dur_v2", global_view_name="ccu049")
