...
# Table names
# 1. Long Covid
#cohort = ".ccu049_02_cohort_longc"
#end_date = "2023-12-31"

# 2. Depression
#cohort = ".ccu049_02_cohort_depression"
#start_date = "2018-01-01"
#end_date = "2023-12-31"

# 3. COPD
#cohort = ".ccu049_02_cohort_copd"
#start_date = "2018-01-01"
#end_date = "2023-12-31"

# 4. Heart Failure
cohort = ".ccu060_hf_base"
#start_date = "2018-01-01"
end_date = "2023-12-31"
hf = spark.sql(f'select * from .ccu060_hf_base')

# 5. Fatigue
#cohort = ".ccu049_02_cohort_fatigue"
#start_date = "2018-01-01"
#end_date = "2023-12-31"


ecds_archive = spark.sql(f'select * from .lowlat_ecds_all_years_archive')
...
#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_longc_ecds_v2", global_view_name="ccu049")
#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_longcoh_ecds_v2", global_view_name="ccu049")
#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_nocovidc_ecds_v2", global_view_name="ccu049")
#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_nocovidh_ecds_v2", global_view_name="ccu049")
#save_checkpoint(df_in=co_final, database="", temp_df="ccu049_onlycovid_ecds_v2", global_view_name="ccu049")
